...
function init(){
  ...
  //llamado al ajax de categoria para traer los options del select de departamentos
  $.post("../ajax/categoria.php?op=select", function (r) {
   // console.log(r);
    $("#idCategoria").html(r);
...
function mostrar(idGasto){
	...
	$.post("../ajax/gasto.php?op=mostrar",{idGasto:idGasto},function(data){
		//console.log(data);
...
function desactivar(idGasto) {
	...
	var ventanaEleccion =toastr.warning('¿Deseas desactivar el gasto seleccionado?<br>'+
	...
	$("#rptaSi").click(function() {
		...
		$.post("../ajax/gasto.php?op=desactivar",{idGasto:idGasto},function(mensaje){
			//alert(mensaje);
...
function activar(idGasto) {
	var ventanaEleccion =toastr.warning('¿Deseas activar el gasto seleccionado?<br>'+
		'<button type="button" id=rptaSi class="btn btn-success">Si</button>'+
		'<button type="button" id=rptaNo class="btn btn-danger">No</button>',"Alerta");

	$("#rptaSi").click(function() {
		//console.log("El usuario ha elegido activar la gasto");
		$.post("../ajax/gasto.php?op=activar",{idGasto:idGasto},function(mensaje){
			//alert(mensaje);
			valida = mensaje.indexOf('error');
